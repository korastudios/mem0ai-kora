...
var IDENTITY_CACHE_MAX_DEFAULT = 50;
var identityByCredentials = /* @__PURE__ */ new Map();
var MemoryClient = class {
  ...
  constructor(options) {
    ...
    this.projectId = null;
    this.identityCacheMax = (_a2 = options.identityCacheMax) != null ? _a2 : IDENTITY_CACHE_MAX_DEFAULT;
    this.headers = {
  ...
  _resolveIdentity() {
    const credentials = `${this.host}\0${this.apiKey}`;
  ...
  async getAll(options) {
    ...
    const queryParams = [];
    if (page !== void 0) queryParams.push(`page=${page}`);
    if (pageSize !== void 0) queryParams.push(`page_size=${pageSize}`);
  ...
  async getWebhooks(data) {
    ...
    if (!(data == null ? void 0 : data.projectId)) await this._awaitIdentity();

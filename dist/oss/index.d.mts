...
declare class Memory {
    ...
    private _normalizeEntityText;
    private _existingEntitiesByText;
    /**
 ...
 */
declare class AWSBedrockEmbedder implements Embedder {
    private readonly model;
    private readonly region;
    private readonly embeddingDims?;
    ...
    private getClient;
    private isCohereModel;
    private isCohereV4Model;
...
declare class LiteLLM extends OpenAILLM {
    constructor(config: LLMConfig);
    generateResponse(messages: Message[], responseFormat?: {
        type: string;
    }, tools?: any[]): Promise<string | LLMResponse>;
 ...
 */
declare function extractProvider(model: string, providerOverride?: string): string;
/**
...
declare function buildRedisFilterExpr(filters?: SearchFilters): string;
...
declare class PGVector implements VectorStore {
    ...
    private readonly useDirectConnection;
    private config;
    private _initPromise?;
...
declare class MongoDB implements VectorStore {
    ...
    private ensureClient;
    initialize(): Promise<void>;
    private textSearchIndexDefinition;
...
declare const DISTANCE_METRICS: readonly ["COSINE", "EUCLIDEAN", "EUCLIDEAN_SQUARED", "DOT", "HAMMING", "MANHATTAN"];
...
declare function buildFilterGroup(filters: Record<string, any>, binds: Record<string, any>): string;
declare function buildWhereClause(filters?: SearchFilters): [string, Record<string, any>];
...
declare class OracleAIVectorSearch implements VectorStore {
    private readonly collectionName;
    private readonly indexName;
    private readonly embeddingModelDims;
    private readonly distanceMetric;
    private readonly indexType;
    private readonly indexParameters;
    private readonly indexAccuracy?;
    private readonly doCreateIndex;
    private readonly config;
    private oracledb;
    private client?;
    private ownsClient;
